                    ...
                    <div class="row ">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <div class="input-group mb-3">
                                <input type="text" name="reserve" value="{{$crypto->reserve}}" class="form-control"
                                       placeholder="0">
                                <div class="input-group-append">
                                    <span class="input-group-text currencyReserveSign">@lang($crypto->code)</span>
                                </div>
                            </div>
                            @error('reserve')
                            <span class="text-danger">{{ $message }}</span>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" name="buy_rate" value="{{$crypto->buy_rate+0}}" class="form-control"
                                       placeholder="0">
                                <div class="input-group-append">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <div class="input-group mb-3">
                                <div class="input-group-prepend">
                                    <span class="input-group-text currencySign">1 {{$crypto->code}}
                                    </span>
                                </div>
                                <input type="text" name="sell_rate" value="{{$crypto->sell_rate+0}}" class="form-control"
                                       placeholder="0">
                                <div class="input-group-append">
                                    <span class="input-group-text">@lang('USD')</span>
                                </div>
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <div class="input-group mb-3">
                                <input type="text" name="minSell" value="{{$crypto->min_sell+0}}" class="form-control"
                                       placeholder="0">
                                <div class="input-group-append">
                                    <span class="input-group-text"> <span
                                            class="minMaxCurrency">{{$crypto->code}}</span></span>
                                </div>
                            </div>
                            @error('minSell')
                            <span class="text-danger">{{ $message }}</span>
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <div class="input-group mb-3">
                                <input type="text" name="maxSell" value="{{$crypto->max_sell+0}}" class="form-control"
                                       placeholder="0">
                                <div class="input-group-append">
                                    <span class="input-group-text"> <span
                                            class="minMaxCurrency">{{$crypto->code}}</span></span>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="input-group">
                                <input type="text" name="commission_rate"
                                       class="form-control"
                                       value="{{ $crypto->commission_rate }}">
                                <div class="input-group-append">
                                    <select class="form-control  mb-3" name="commission_type" aria-label=".form-select-lg example">
                                        <option value="0" @if($crypto->commission_type==0) selected @endif class="minMaxCurrency">@lang($crypto->code)</option>
                                        <option value="1" @if($crypto->commission_type==1) selected @endif>%</option>
                                    </select>
                                </div>
                            ...
                            <div class="card shadow">
                                <div class="card-body">
                                    ...
                                    <div class=" row addedField">
                                        @if ($crypto->form_field)
                                            @foreach ($crypto->form_field as $k => $v)
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <div class="input-group">
                            ...
                            <div class="card shadow">
                                <div class="card-body">
                                    ...
                                    <div class=" row addedSpecification">
                                        @if ($crypto->receiver_form)
                                            @foreach ($crypto->receiver_form as $k => $v)
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <div class="input-group">
                            ...
                            <div class="row">
                                <div class="form-group col-md-12">
                                    ...
                                    <input data-toggle="toggle" id="buyStatus" data-onstyle="success"
                                           data-offstyle="info" data-on="Active" data-off="Deactive" data-width="100%"
                                           type="checkbox" @if($crypto->buy_status == 1) checked @endif name="buyStatus">
                                    @error('buyStatus')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="row">
                                <div class="form-group col-md-12">
                                    ...
                                    <input data-toggle="toggle" id="sellStatus" data-onstyle="success"
                                           data-offstyle="info" data-on="Active" data-off="Deactive" data-width="100%"
                                           type="checkbox" @if($crypto->sell_status == 1) checked @endif name="sellStatus">
                                    @error('sellStatus')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
