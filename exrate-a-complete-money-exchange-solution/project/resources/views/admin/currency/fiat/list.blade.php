...
@section('content')
        ...
        <div class="card card-primary m-0 m-md-4 my-4 m-md-0 shadow">
            <div class="card-body">
                ...
                <form method="post" action="{{route('admin.fiatControl.action')}}" novalidate="novalidate"
                      class="needs-validation base-form ">
                    @csrf
                    <div class="row justify-content-center align-items-center">
                        <div class="form-group col-lg-6 col-md-6">
                            <label class="d-block">@lang('Fiat Currency Api')</label>
                            <div class="input-group">
                                <input type='text' value='{{old('fiat_currency_api',$control->fiat_currency_api)}}' name='fiat_currency_api' class="form-control" placeholder="@lang('Get your rate API key from apilayer.com')">
                        ...
                        <div class="form-group col-lg-3 col-md-3">
                            ...
                            <div class="custom-switch-btn">
                                ...
                                <input type="checkbox" name="fiat_currency_status" class="custom-switch-checkbox"
                                       ...
                                       value="0" <?php if ($control->fiat_currency_status == 0):echo 'checked'; endif ?> >
            ...
            <div class="table-responsive">
                <table class="categories-show-table table table-hover table-striped table-bordered" id="zero_config">
                    ...
                    <tr>
                        ...
                        <th scope="col">@lang('Buy Rate') <small>(@lang('per') {{config('basic.currency')}})</small></th>
                        <th scope="col">@lang('Sell Rate') <small>(@lang('per') {{config('basic.currency')}})</small></th>
                    ...
                    @forelse($currency as  $item)
                        <tr>
                            ...
                            <td data-label="@lang('Buy Rate')">
                                <span class="text-dark font-weight-bold">{{$item->symbol}}{{$item->buy_rate+0}}
                            </td>
                            <td data-label="@lang('Sell Rate')">
                                <span class="text-dark font-weight-bold">{{$item->symbol}}{{$item->sell_rate+0}}
                            </td>
        ...
        <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
            ...
            <div class="modal-dialog">
                <div class="modal-content ">
                    ...
                    <div class="modal-body">
                        <p class="">{{trans('Get your rate API key from')}} <a href="https://apilayer.com/">{{trans('apilayer.com')}}</a></p>
