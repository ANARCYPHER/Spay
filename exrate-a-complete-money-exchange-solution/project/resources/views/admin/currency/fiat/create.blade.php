            ...
            <form action="{{route('admin.storeFiat')}}" class="form-row justify-content-center" method="post"
                ...
                <div class="col-md-8">
                    <div class="row ">
                        <div class=" col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="name" value="{{old('name')}}"
                                       placeholder="@lang('eg. American Dollar, Indian Rupee')" class="form-control">
                                @error('name')
                        ...
                        <div class=" col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="code" value="{{old('code')}}"
                                       placeholder="@lang('eg. USD, INR')" class="form-control">
                                @error('code')
                                <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class=" col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="symbol" value="{{old('symbol')}}"
                                       placeholder="@lang('eg. $, ₹')" class="form-control">
                                @error('symbol')
                                <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <div class="input-group-append">
                                    <span class="input-group-text currencyReserveSign">@lang(config('basic.currency'))</span>
                                </div>
                            </div>
                            @error('reserve')
                            <span class="text-danger">{{ $message }}</span>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <div class="input-group mb-3">
                                <div class="input-group-prepend">
                                    <span class="input-group-text">@lang('1 '){{config('basic.currency')}}@lang(' = ')</span>
                                </div>
                                <input type="text" name="buy_rate" value="{{old('buy_rate')}}" class="form-control"
                                       placeholder="0">

                                <div class="input-group-append">
                                    <span class="input-group-text currencyReserveSign">{{config('basic.currency')}}</span>
                                </div>
                            </div>
                            @error('buy_rate')
                            <span class="text-danger">{{ $message }}</span>
                        ...
                        <div class="col-md-12">
                            <div class="d-flex justify-content-between mb-3">
                                <h5 class="card-title">@lang('Receive Curency Form')</h5>
                                <a href="javascript:void(0)" class="btn btn-dark btn-sm btn-rounded"
