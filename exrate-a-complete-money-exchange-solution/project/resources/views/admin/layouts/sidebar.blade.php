    ...
    <div class="scroll-sidebar" data-sidebarbg="skin6">
        ...
        <nav class="sidebar-nav">
            <ul id="sidebarnav">
                ...
                <li class="list-divider"></li>
                <li class="nav-small-cap"><span class="hide-menu">@lang('Exchange History')</span></li>



                    <li class="sidebar-item">
                        <a href="{{ route('admin.exchange.orderPendingList') }}" class="sidebar-link">
                            <i class="fas fa-spinner"></i>
                            <span class="hide-menu">@lang('Pending')</span>
                        </a>
                    </li>
                    <li class="sidebar-item">
                        <a href="{{ route('admin.exchange.orderCompleteList') }}" class="sidebar-link">
                            <i class="fas fa-check-circle"></i>
                            <span class="hide-menu">@lang('Complete')</span>
                        </a>
                    </li>
                    <li class="sidebar-item">
                        <a href="{{ route('admin.exchange.orderRejectList') }}" class="sidebar-link">
                            <i class="fas fa-times-circle"></i>
                            <span class="hide-menu">@lang('Reject')</span>
                        </a>
                    </li>
                    <li class="sidebar-item">
                        <a href="{{ route('admin.exchange.orderList') }}" class="sidebar-link">
                            <i class="fas fa-list-alt"></i>
                            <span class="hide-menu">@lang('All Exchange')</span>
                        </a>
                    </li>

                <li class="list-divider"></li>
                <li class="nav-small-cap"><span class="hide-menu">@lang('Testimonial')</span></li>

                <li class="sidebar-item {{menuActive(['admin.testimonial'],3)}}">
                    <a class="sidebar-link" href="{{ route('admin.testimonial') }}" aria-expanded="false">
                        <i class="fa fa-comment-dots" aria-hidden="true"></i>
                        <span class="hide-menu">@lang('Testimonial')</span>
                    </a>
