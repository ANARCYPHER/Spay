                        ...
                        <div class="card-body">
                            <form action="{{ route('user.payout.history.search') }}" method="get">
                                <div class="row justify-content-between">
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group mb-2">
                                            <button type="submit" class="btn-ico w-100">
                                    ...
                                    @forelse($payoutLog as $item)
                                        <tr>
                                            ...
                                            <td data-label="@lang('Detail')">
                                                <button type="button" class="btn btn-sm btn-custom-success infoButton "
        ...
        <div class="modal-dialog">
            <div class="modal-content form-block">
                ...
                <div class="modal-body">
                    <form>
                        <ul class="list-group ">
                            <li class="list-group-item-payout bg-transparent">@lang('Transactions') : <span class="trx"></span>
                            </li>
                            <li class="list-group-item-payout bg-transparent">@lang('Admin Feedback') : <span
            ...
            $('.infoButton').on('click', function () {
                ...
                for (var i = 0; i < information.length; i++) {
                    if (information[i][1].type == 'file') {
                        result += `<li class="list-group-item-payout bg-transparent">
