...
INSERT INTO `users` (`id`, `account_type`, `username`, `name`, `email`, `password`, `avatar`, `language`, `data`, `token`, `banned`, `chatboxban`, `created`, `chatboxbanreason`) VALUES
(1, 'admin', 'admin', 'admin', 'admin@admin.com', '938c8a307c7cd31299e70a0e4c1ad372', '', NULL, '{\"social\":{\"facebook\":\"\",\"twitter\":\"\",\"instagram\":\"\",\"youtube\":\"\"}}', 'd4c1a9117adbea3effb8e8553565dafa', 0, 0, '2021-01-09 18:02:08', NULL);
