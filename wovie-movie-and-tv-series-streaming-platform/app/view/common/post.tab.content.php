...
<div class="form-group">
    ...
    <input name="movie_download" class="form-control" placeholder="<?php echo __('Download URL');?>" value="<?php echo $Listing['movie_download']; ?>">
</div>
        <?php } ?>
<div class="row">
    <div class="col-md-3">
    ...
    <div class="col-md-3">
        <div class="form-group">
            ...
            <input type="text" name="imdb" class="form-control" placeholder="IMDB Puan?" value="<?php echo $Listing['imdb']; ?>">
        </div>
    </div>
    <div class="col-md-3">
        <div class="form-group">
