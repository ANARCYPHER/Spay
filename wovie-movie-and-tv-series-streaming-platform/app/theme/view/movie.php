        ...
        <div class="detail-text flex-fill">
            <div class="caption">
                <div class="caption-content">
					...
					<?php if($Listing['title_sub']) { ?>
                    	<?php echo __('Also Known As');?>: <h2 style="display:inline;"><?php echo $Listing['title_sub'];?></h2>
							<br />
						<?php } ?>
                	</div>
                    <?php if($Listing['imdb']) { ?>
        ...
        <div class="row row-cols-6 list-scrollable">
            ...
            <div class="col">
                <div class="list-movie">
                    <a href="<?php echo APP . '/'. $Similar['type'] . '/' . $Similar['self'] . '-' . $Similar['create_year'] .'-'. $Similar['id'];?>" class="list-media">
...
<?php if($Similar['mpaa']) { ?><div class="media-cover mpaa"><?php echo $Similar['mpaa'];?></div><?php } ?>
                    ...
                    <div class="list-caption">
                        <a href="<?php echo APP . '/'. $Similar['type'] . '/' . $Similar['self'] . '-' . $Similar['create_year'] .'-'. $Similar['id'];?>" class="list-title">
