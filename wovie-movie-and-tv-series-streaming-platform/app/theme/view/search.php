                ...
                <div class="tab-content">
                        ...
                        <div class="row row-cols-5">
                            ...
                            <div class="col">
                                <div class="list-movie">
                                    <a href="<?php echo APP . '/movie/'. $Movie['self'] .'-'. $Movie['create_year'] . '-' . $Movie['id'];?>" class="list-media">
                                        ...
                                        <div class="media media-cover" style="background-image:url('<?php echo $Movie['image'];?>');"></div>
                                    </a>
                                    <div class="list-caption">
                                        <a href="<?php echo post($Movie['id'],$Movie['self'],$Movie['type']);?>" class="list-title">
                                            <?php echo $Movie['title'];?>
                                        </a>
                                        <a href="<?php echo post($Movie['id'],$Movie['self'],$Movie['type']);?>" class="list-category">
                    ...
                    <div class="tab-pane" id="series" role="tabpanel" aria-labelledby="series-tab">
                        <div class="row row-cols-5">
                            ...
                            <div class="col">
                                <div class="list-movie">
                                    <a href="<?php echo APP . '/show/'. $Serie['self'] .'-'. $Serie['create_year'] . '-' . $Serie['id'];?>" class="list-media">
                                        <?php if($Serie['quality']) { ?>
                                        <div class="list-media-attr">
                                            <div class="quality">
                                                <?php echo $Serie['quality'];?>
                                            </div>
                                        </div>
                                        <?php } ?>
                                        <div class="play-btn">
                                        ...
                                        <div class="media media-cover" style="background-image:url('<?php echo $Serie['image'];?>');"></div>
                                    </a>
                                    <div class="list-caption">
                                        <a href="<?php echo post($Serie['id'],$Serie['self'],$Serie['type']);?>" class="list-title">
                                            <?php echo $Serie['title'];?>
                                        </a>
                                        <a href="<?php echo post($Serie['id'],$Serie['self'],$Serie['type']);?>" class="list-category">
