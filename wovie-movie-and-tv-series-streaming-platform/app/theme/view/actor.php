...
<div class="flex-fill">
    ...
    <div class="app-section">
        <div class="actor-profile">
            <div class="row">
                <div class="col-md-3">
                    <div class="media" data-src="<?php echo $Listing['image']; ?>"></div>
...
<a href="<?php if($Post['type'] == 'serie') { echo APP. '/show/'; } else { echo '/movie/'; } echo $Post['self'] . '-' . $Post['create_year'] . '-' . $Post['content_id'];?>" class="list-media">
                    <?php if($Post['quality'] || $Post['imdb']) { ?>
                    <div class="list-media-attr">
                        <?php if($Post['quality']) { ?>
                        <div class="quality">
                            <?php echo $Post['quality'];?>
                        </div>
                        <?php } ?>
                        <?php if($Post['imdb']) { ?>
                        <div class="imdb">
                            ...
                            <svg x="0px" y="0px" width="36px" height="36px" viewBox="0 0 36 36">
                                <circle fill="none" stroke-width="1" cx="18" cy="18" r="16" stroke-dasharray="<?php echo round($Post['imdb'] / 10 * 100);?> 100" stroke-dashoffset="0" transform="rotate(-90 18 18)"></circle>
                            </svg>
                        </div>
                        <?php } ?>
                    </div>
                    <?php } ?>
                                            ...
                                            <div class="media media-cover" data-src="<?php echo $Post['image']; ?>">
